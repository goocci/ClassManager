	...
	<div id="wrapper2" align="center" style="width: 700px;">
		<fieldset>
			...
			<div align="center">
				...
				<form class="form-horizontal" method="post" action="modify_confirm" name="frm">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<div style="float: left; width: 100%;">
								<input class="form-control" id="new_teacherno" type="text"
									name="new_teacherno" placeholder="교번" value="${teacherno }"
									readonly="readonly" />
							</div>
							<div></div>
						</div>
